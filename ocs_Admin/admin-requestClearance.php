...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid myPage">
            ...
            <hr>
            <?php
            if (Session::exists('approved')){
                ?>
                <span class="text-center text-sm text-success" style="font-size:24px;">
    ...
    <div class="content">
        <div class="container-fluid">
            <a href="<?=URLROOT?>ocs_Admin/admin-cleared" class="btn btn-info">Cleared Students</a>
            <hr>
            <div class="container">
                <div class="table-responsive" id="showRequestsdpt">
...
<script>
    ...
    $(document).ready(function(){
        ...
        function fetch_request(){
            action = 'fetch_requestDpt';
            $.ajax({
                url:'script/clearance-process.php',
                method:'post',
                data:{action:action},
                success:function(response){
                    $('#showRequestsdpt').html(response);
                    $('#showRequestdp').DataTable({
                        "paging": true,
                        "lengthChange": false,
                        "searching": true,
                        "ordering": true,
