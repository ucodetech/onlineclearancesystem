<?php
    ...
    if(!hasPermissionSuper()){
        Session::flash('denied', 'You have permission to access that page!');
...
<style>
    ...
    <div class="content">
      <div class="container-fluid">
        <a href="<?URLROOT;?>admin-register" class="btn btn-info">Add Admin</a>
          <hr>
   			<div class="container" id="showbook">
